...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stat', models.PositiveIntegerField(choices=[(1, 'Review'), (2, 'accepted'), (3, 'rejected')], default=0)),
                ('money', models.PositiveIntegerField()),
                ('LID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='LoanApplication', to='service.loan_options')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Fund_applications',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stat', models.PositiveIntegerField(choices=[(1, 'Review'), (2, 'accepted'), (3, 'rejected')], default=0)),
                ('money', models.PositiveIntegerField()),
                ('FID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FundApplication', to='service.fund_options')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
